...
from Modul import create_a_new_folder, copy_content_of_folder, replace_files_from_folder, delete_content_of_folder, \
    initialize_current_version, count_directories
...
class Repository:
    ...
    def log(self):
        ...
        for commit_name in list_files:
            ...
            commit_path = os.path.join(self.path_commiting, commit_name)
